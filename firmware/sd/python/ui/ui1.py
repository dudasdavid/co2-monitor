...
def create_system_table(alt=False):
    ...
    table.set_cell_value(5, 0, "SD card status")
    table.set_cell_value(6, 0, "/flash storage")
    table.set_cell_value(7, 0, "/sd storage")
    table.set_cell_value(8, 0, "RAM")
    table.set_cell_value(9, 0, "Lux")
    table.set_cell_value(10, 0, "Backlight")
    table.set_cell_value(11, 0, "i2c SCD41")
    table.set_cell_value(12, 0, "i2c AHT21")
    table.set_cell_value(13, 0, "i2c ENS160")
    table.set_cell_value(14, 0, "i2c BMP280")
    table.set_cell_value(15, 0, "i2c VEML7700")
    table.set_cell_value(16, 0, "i2c DS3231")
    table.set_cell_value(17, 0, "i2c DRV2605")
    table.set_cell_value(18, 0, "i2c PCA9685")
    table.set_cell_value(19, 0, "i2c SPS30")
    table.set_cell_value(20, 0, "Unknown devices")
    table.set_cell_value(21, 0, "USB voltage")
    table.set_cell_value(22, 0, "5V voltage")
    table.set_cell_value(23, 0, "Ideal diode voltage")
    table.set_cell_value(24, 0, "Battery voltage")
    table.set_cell_value(25, 0, "Battery %")
    table.set_cell_value(26, 0, "Charging")
    table.set_cell_value(27, 0, "LED feedback")
    table.set_cell_value(28, 0, "ADC task")
    table.set_cell_value(29, 0, "Backlight task")
    table.set_cell_value(30, 0, "History task")
    table.set_cell_value(31, 0, "i2c task")
    table.set_cell_value(32, 0, "Idle task")
    table.set_cell_value(33, 0, "Serial task")
    table.set_cell_value(34, 0, "Storage task")
    ...
    def table_update_cb(task):
        ...
        table.set_cell_value(5, 1, var.system_data.status_sd)
        table.set_cell_value(6, 1, "{}kB / {}kB".format(int(var.system_data.used_space_flash), int(var.system_data.total_space_flash)))
        table.set_cell_value(7, 1, "{}MB / {}MB".format(int(var.system_data.used_space_sd), int(var.system_data.total_space_sd)))
        table.set_cell_value(8, 1, "{:.1f}MB / {:.1f}MB".format(var.system_data.used_heap/1024.0, var.system_data.total_heap/1024.0))
        table.set_cell_value(9, 1, "{:.2f}".format(var.sensor_data.lux_veml7700)) # This comes from sensor data!
        table.set_cell_value(10, 1, "{} / 1000".format(int(var.system_data.bl_duty_percent)))
        table.set_cell_value(11, 1, "{}".format(var.system_data.i2c_status_scd41))
        table.set_cell_value(12, 1, "{}".format(var.system_data.i2c_status_aht21))
        table.set_cell_value(13, 1, "{}".format(var.system_data.i2c_status_ens160))
        table.set_cell_value(14, 1, "{}".format(var.system_data.i2c_status_bmp280))
        table.set_cell_value(15, 1, "{}".format(var.system_data.i2c_status_veml7700))
        table.set_cell_value(16, 1, "{}".format(var.system_data.i2c_status_ds3231))
        table.set_cell_value(17, 1, "{}".format(var.system_data.i2c_status_drv2605))
        table.set_cell_value(18, 1, "{}".format(var.system_data.i2c_status_pca9685))
        table.set_cell_value(19, 1, "{}".format(var.system_data.i2c_status_sps30))
        if len(var.system_data.i2c_status_unknown) > 0:
            hex_list = ["0x{:02X}".format(v) for v in var.system_data.i2c_status_unknown]
            table.set_cell_value(20, 1, "Unknown device(s) at {}".format(", ".join(hex_list)))
        else:
            table.set_cell_value(20, 1, "There are no unknown devices.")
        table.set_cell_value(21, 1, "{:.2f}".format(var.system_data.usb_volt))
        table.set_cell_value(22, 1, "{:.2f}".format(var.system_data.dcdc_volt))
        table.set_cell_value(23, 1, "{:.2f}".format(var.system_data.ideal_diode_volt))
        table.set_cell_value(24, 1, "{:.2f}".format(var.system_data.bat_volt))
        table.set_cell_value(25, 1, "{}".format(int(var.system_data.bat_percentage)))
        table.set_cell_value(26, 1, "{}".format(var.system_data.charging))
        table.set_cell_value(27, 1, "{}".format(var.system_data.feedback_led))
        table.set_cell_value(28, 1, "{}".format(var.system_data.adc_task_timestamp))
        table.set_cell_value(29, 1, "{}".format(var.system_data.backlight_task_timestamp))
        table.set_cell_value(30, 1, "{}".format(var.system_data.history_task_timestamp))
        table.set_cell_value(31, 1, "{}".format(var.system_data.i2c_task_timestamp))
        table.set_cell_value(32, 1, "{}".format(var.system_data.idle_task_timestamp))
        table.set_cell_value(33, 1, "{}".format(var.system_data.serial_task_timestamp))
        table.set_cell_value(34, 1, "{}".format(var.system_data.storage_task_timestamp))
